...
export type TestConfigurationInput<U extends User = User, V extends Variants = Variants> = {
  /**
...
export type TestsInput<U extends User = User, V extends Variants = Variants> = Record<
  TestId,
  TestConfigurationInput<U, V>
>;
...
export type TestConfiguration<
  U extends User = User,
  V extends StandardVariants = StandardVariants
> = {
  /**
   * Short description - optional
   */
...
export type Tests<U extends User = User, V extends StandardVariants = StandardVariants> = Record<
  TestId,
