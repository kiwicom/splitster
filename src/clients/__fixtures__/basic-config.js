...
export const BASIC_CONFIG_WITH_DISABLED_WITH_REASON = {
  mockSeedRandomImplementation,
  config: CONFIG_WITH_DISABLED_WITH_REASON,
};
export const BASIC_CONFIG_WITH_DISABLED_WITH_DEFAULT_VARIANT = {
  mockSeedRandomImplementation,
  config: CONFIG_WITH_DISABLED_WITH_DEFAULT_VARIANT,
};
export const BASIC_CONFIG_WITH_VERSION = {
  mockSeedRandomImplementation,
  config: CONFIG_WITH_VERSION,
};
export const BASIC_CONFIG_WITH_DISABLED_WITH_DEFAULT_VARIANT_WITH_VERSION = {
  mockSeedRandomImplementation,
  config: CONFIG_WITH_DISABLED_WITH_DEFAULT_VARIANT_WITH_VERSION,
};
