...
describe("filterCookiesByPrefix", () => {
  ...
  it("should return cookies specific to Splitster -- CUSTOM PREFIX", () => {
    ...
    const SPLITSTER_COOKIES_WITH_CUSTOM_PREFIX_KEYS = Object.keys(SPLITSTER_COOKIES_WITH_CUSTOM_PREFIX)
    const COOKIES = {
     ...SPLITSTER_COOKIES_WITH_CUSTOM_PREFIX,
     ...RANDOM_COOKIES,
    }
      expect(filterCookiesByPrefix(COOKIES, prefix)).toEqual(SPLITSTER_COOKIES_WITH_CUSTOM_PREFIX_KEYS);
    })
})
