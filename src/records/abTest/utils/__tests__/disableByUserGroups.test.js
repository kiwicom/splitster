...
describe("disableByUserGroups", () => {
  ...
  it("should not change if already disabled", () => {
    expect(disableByUserGroups({})(["X", { disabled: true }])).toEqual(["X", { disabled: true }]);
  });
  ...
  it("should not change if test user group is empty", () => {
    expect(disableByUserGroups({}, {})(["X", { userGroup: {} }])).toEqual(["X", { userGroup: {} }]);
  });

  it("should corerctly disable by user group", () => {
    expect(disableByUserGroups({ lang: "en", browser: "chrome" }, {})(["TEST_1", TEST_1])).toEqual([
      "TEST_1",
      { ...TEST_1, ...enabled },
    ]);
    expect(disableByUserGroups({ lang: "cz", browser: "chrome" }, {})(["TEST_1", TEST_1])).toEqual([
      "TEST_1",
      { ...TEST_1, ...disabledUserGroup },
    ]);
    expect(disableByUserGroups({ lang: "en", browser: "safari" }, {})(["TEST_1", TEST_1])).toEqual([
      "TEST_1",
      { ...TEST_1, ...disabledUserGroup },
    ]);
  });
  ...
  it("should disable by user group exclude for all", () => {
    expect(
      disableByUserGroups({ lang: "en", browser: "chrome" }, {}, true)(["TEST_2", TEST_2]),
    ).toEqual(["TEST_2", { ...TEST_2, ...disabledUserGroupExclude }]);
  });
  it("should disable by user group exclude for at least one user group", () => {
    expect(
      disableByUserGroups({ lang: "cz", browser: "chrome" }, {}, true)(["TEST_2", TEST_2]),
    ).toEqual(["TEST_2", { ...TEST_2, ...disabledUserGroupExclude }]);
    expect(
      disableByUserGroups({ lang: "en", browser: "safari" }, {}, true)(["TEST_2", TEST_2]),
    ).toEqual(["TEST_2", { ...TEST_2, ...disabledUserGroupExclude }]);
  });
  it("should pass user group excklude", () => {
    expect(
      disableByUserGroups({ lang: "cz", browser: "safari" }, {}, true)(["TEST_2", TEST_2]),
