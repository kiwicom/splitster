...
import { SplitsterInitConfig, TestConfiguration, VariantConfiguration } from "../../..";

export const defaultConfig: SplitsterInitConfig<{}, {}> = {
  tests: {},
  options: {
    cookies: {
      disabled: false,
...
export const defaultTestConfig: TestConfiguration<{}, {"": VariantConfiguration}> = {
  description: "",
  userGroup: {},
  userGroupExclude: {},
  usage: 100,
